...
document.getElementById('button-perfil').addEventListener('click', () => {
    const seccionMenuUsuario = document.getElementById('seccion-menu-usuario-editor');
    const body = document.getElementById('body');
...
document.getElementById('button-ajustes-editor').addEventListener('click', () => {
    const seccionOpcionesAjustes = document.getElementById('seccion-opciones-ajustes-editor');
    const body = document.getElementById('body');
